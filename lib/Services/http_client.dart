...
class HttpService {
  ...
  Future<Response> updateProfile(String firstName, String lastName,
      String phoneNumber, String email, String token) async {
    var url = Uri.https(baseURL, updateUserProfile);
    var body = {
      "firstname": firstName,
      "lastname": lastName,
      "tel": phoneNumber,
  ...
  Future<Response> updatePassword(String currentPassword, String password,
      String passwordConfirmation, String token) async {
    var url = Uri.https(baseURL, updateUserPassword);
    var body = {
  ...
  //GetAllCardSForAUser
  Future<List<GetAllCardForAUserResponseModel>>? userAllCardDetailsForUser(
      String token) async {
  ...
  Future<List<GetAllTransactionModelResponse>>? getAllTransactions(
      String token) async {
  ...
  //SignUp
  Future<Response> makeTransaction(
      String vendorId,
      String cardId,
      String riderId,
      String addressId,
