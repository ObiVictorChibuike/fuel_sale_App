...
class BottomNavigationBarFourthScreen extends StatefulWidget {
  ...
  @override
  _BottomNavigationBarFourthScreenState createState() =>
      _BottomNavigationBarFourthScreenState();
}

class _BottomNavigationBarFourthScreenState
    extends State<BottomNavigationBarFourthScreen> {
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return Expanded(
                            child: ListView.builder(
                                shrinkWrap: true,
                                itemCount:
                                    MessageCenter.messageCenterModel.length,
                                itemBuilder: (BuildContext context, int index) {
                                  return Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 19.0, vertical: 19.0),
                                    child: GestureDetector(
                                      onTap: () {
                                        changeScreen(
                                            context, MessageCenterDetails());
                                      },
                                      child: Card(
                                        elevation: 0.0,
                                        child: Container(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      backgroundColor: Colors.primaries[
                                          _random.nextInt(RandomColors
                                              .randomColors.length)],
                                      //[_random.nextInt(9) * 100],
                                      radius: 25,
                                      child: Text(
                                        ChatModel.chatModel[index].avatar!
                                            .substring(0, 1),
                                        style: TextStyle(
                                            fontFamily: 'Nunito',
                                            fontSize: 30,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ChatModel.chatModel[index].name!,
                                          style: TextStyle(
                                              fontFamily: 'Nunito',
                                              fontSize: 18,
                                              fontWeight: FontWeight.w600,
